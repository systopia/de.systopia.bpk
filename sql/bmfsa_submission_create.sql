...
CREATE TABLE IF NOT EXISTS `civicrm_bmfsa_submission` (
     ...
     INDEX `year` (`year`),
     INDEX `date` (`date`),
     CONSTRAINT FK_civicrm_bmfsa_submission_created_by FOREIGN KEY (`created_by`) REFERENCES `civicrm_contact`(`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE IF NOT EXISTS `civicrm_bmfsa_record` (
     `id`            int unsigned  NOT NULL AUTO_INCREMENT,
